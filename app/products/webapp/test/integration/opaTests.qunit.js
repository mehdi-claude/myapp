...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/myapp/products/test/integration/FirstJourney",
    "com/myapp/products/test/integration/ProductsListJourney",
    "com/myapp/products/test/integration/ProductsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
